...
<div class="flex items-center justify-center gap-2">
  <a href={{ route($baseRoute . '.edit', ['id' => $id]) }} class="bg-orange-500 flex p-2 rounded-md">
